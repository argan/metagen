...
public class TestDoclet {
    ...
    public static void main(String[] arg) {
        ...
        Main.execute("javadoc", TestDoclet.class.getName(), new String[] { "-private", "-sourcepath", srcDir,// 源文件位置
                "-encoding", "UTF-8", "-subpackages", "com.alipay.ardp.core.model",// 要处理的package
                                                                                   // name
        });
